...
Generated by 'django-admin startproject' using Django 4.x.x.
For more information on this file, see
https://docs.djangoproject.com/en/4.x/topics/settings/
For the full documentation, see
https://docs.djangoproject.com/en/4.x/
"""
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Add this line if needed
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Email backend for sending confirmation emails
# (For development purposes, the console backend sends email to the console)
